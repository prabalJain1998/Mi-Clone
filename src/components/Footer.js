...
const Footer = ({footer}) => {
  return (
    <>
        ...
        <div>
            {repeatIcon}
           <p><b>Hassle-free replacement</b><br/> 10 days replacement policy on mi.com </p>
        </div>
        <div>
            {shieldIcon}
        ...
        <div>
            {mapIcon}
           <p><b>Vast Service Network</b><br/> 1000 Mi Servie-centers across 600 cities</p>
        </div>
        </div>  
        ...
        <div className="footerBorder">
            <div> Cpoyright c 2010 - 2021 Xiaomi. All Rights Reserved</div>
        </div>
    </>
  )
}
